...
const NotFoundPage = (): JSX.Element => (
    <Layout>
        ...
        <Stack spacing={10}>
            <Heading as="h1" size='3xl' textTransform="uppercase">COOKIES & PRIVACY</Heading>

            <Heading size="2xl">Wat is een cookie?</Heading>
            <Text fontSize="3xl">
            ...
            <Heading size="2xl">En Hersenvulsel gebruikt dat?</Heading>
            <Text fontSize="3xl">
            ...
            <Heading size="2xl">Waarvoor gebruikt Hersenvulsel cookies?</Heading>
            <Text fontSize="3xl">
            ...
            <Heading size="2xl">Houden jullie nog andere persoonlijke gegevens bij?</Heading>
            <Text fontSize="3xl">
